...
class VisitCountries extends Component {
  ...
  onClickVisitButton = () => {
    this.setState(prevState => ({isVisited: !prevState.isVisited}))
  }
      ...
      <div className="app-container">
        <div className="countries-name-container">
          ...
          <ul className="country-names-list">
            {countriesList.map(eachCountryName => (
              <VisitItem
                key={eachCountryName.id}
                countriesDetails={eachCountryName}
                onClickButton={this.onClickVisitButton}
              />
            ))}
          </ul>
        </div>
        <div className="visited-countries-container">
          ...
          {countriesList.length > 0 ? (
            <ul className="country-images-list">
              {countriesList.map(eachCountryImage => (
                <CountryImageItem
                  key={eachCountryImage.id}
                  imageDetails={eachCountryImage}
